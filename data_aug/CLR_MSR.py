...
class ContrastiveLearningMSRDataset(Dataset):
    def __init__(self, root, frames_per_clip=16, step_between_clips=1, step_between_frames=2, num_points=2048, sub_clips=5, train=True):
        super(ContrastiveLearningMSRDataset, self).__init__()
