...
def main(args):
    ...
    if os.path.isfile(args.finetune):
        ...
        assert log.missing_keys == ['module.fc_out0.weight', 'module.fc_out0.bias']
...
def parse_args():
    ...
    parser.add_argument('--finetune', default='/ml_workspace/yckj3949/code/sxx2/0425-Point-sequences-unsupervised-dp-global/log_ssl_dp_mlp_bn/NTU60/checkpoint_150.pth', help='finetune from checkpoint')
    ...
    parser.add_argument('--output-dir', default='output_linear_dp_150epoch_1bn_2fcbn_msr_notransmlp_wd_5e-4_cos_b35_warm10_noconvfc_embedding_r0.3_alldata_linear_onefc_transfer/', type=str, help='path where to save')
    parser.add_argument('--log-dir', default='log_linear_dp_150epoch_1bn_2fcbn_msr_notransmlp_wd_5e-4_cos_b35_warm10_noconvfc_embedding_r0.3_alldata_linear_onefc_transfer/', type=str, help='path where to save')
